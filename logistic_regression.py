...
def do_experiments(start, end, step_num):
    ...
    for i, distance in enumerate(shift_distances, 1):
        ...
        class0_mask = y == 0
        class1_mask = y == 1
        plt.scatter(X[class0_mask, 0], X[class0_mask, 1], c='blue', label='Class 0', alpha=0.6)
        plt.scatter(X[class1_mask, 0], X[class1_mask, 1], c='red', label='Class 1', alpha=0.6)
        ...
        # Plot confidence contours and calculate margin width
    ...
    # Plot beta0
    plt.subplot(3, 3, 1)
    plt.plot(shift_distances, beta0_list, 'b-', linewidth=2)
    ...
    # Plot beta1
    plt.subplot(3, 3, 2)
    plt.plot(shift_distances, beta1_list, 'g-', linewidth=2)
    ...
    # Plot beta2
    plt.subplot(3, 3, 3)
    plt.plot(shift_distances, beta2_list, 'r-', linewidth=2)
    ...
    plt.subplot(3, 3, 4)
    plt.plot(shift_distances, slope_list, 'p-', linewidth=2)
    ...
    plt.subplot(3, 3, 5)
    plt.plot(shift_distances, [-b0/b2 for b0, b2 in zip(beta0_list, beta2_list)], 'm-', linewidth=2)
    ...
    # Plot logistic loss
    plt.subplot(3, 3, 6)
    plt.plot(shift_distances, loss_list, 'k-', linewidth=2)
    ...
    # Plot margin width
    plt.subplot(3, 3, 7)
    plt.plot(shift_distances, margin_widths, 'c-', linewidth=2)
